...
public class LombokPlugin extends PluginAdapter {
	...
	/**
	 * @param warnings listByHotelId of warnings
	 * @return always true
	 */
...
//		annotations.add(Annotations.ALL_ARGS_CONSTRUCTOR);
		...
		annotations.add(Annotations.ACCESSORS.appendOptions("chain","true"));
...
//		return super.clientGenerated(interfaze, topLevelClass, introspectedTable);
	...
	private enum Annotations {
		...
		private Annotations appendOptions(String key, String value) {
